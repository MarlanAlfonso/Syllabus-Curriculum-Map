...
export default function AddCourseModal({ onClose, onCourseAdded }) {
  const [form, setForm] = useState({
    ...
    units: "", yearLevel: "", semester: "", skills: [],
  });
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, paddingTop: 16, borderTop: "1px solid #f3f4f6" }}>
          ...
          <button onClick={handleSave}
            style={{ height: 36, padding: "0 18px", borderRadius: 8, border: "1px solid #3b82f6", background: "#eff6ff", color: "#1d4ed8", cursor: "pointer", fontSize: 14, fontWeight: 500 }}>
            Save Course
          </button>
        </div>
      </div>
